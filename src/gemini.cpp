...
String text_request_top = ". What could a child draw using these colours? Please recommend 2 simple things to draw based on these colours, responding as if you were talking to a young child, complementing their colours. They could be scenes, things, animals, etc. Please do not mention the RGB values. Output only plain text on one line. Do not output markdown.";
