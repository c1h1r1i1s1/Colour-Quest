...
// // Color adjustment for color-blind mode (adjusts red channel)
// int adjustForColorBlindness(int r, int g, int b) {
//   int adjustedR = refR > 100 ? (r * 2) : r+50; // Reduces the impact of red for color-blind users
...
//     Serial.print(inputR); Serial.print(", G=");
//     Serial.print(inputG); Serial.print(", B=");
//     Serial.println(inputB); 

//     // Calculate similarity for normal mode
//     int accuracyNormal = calculateSimilarity(inputR, inputG, inputB);
//     Serial.print("Normal mode accuracy: ");
//     Serial.println(accuracyNormal);

//     // Calculate similarity for color-blind mode
//     int accuracyColorBlind = adjustForColorBlindness(inputR, inputG, inputB);
//     Serial.print("Color-blind mode accuracy: ");
//     Serial.println(accuracyColorBlind);

//     // Determine the higher accuracy
//     int finalAccuracy = max(accuracyNormal, accuracyColorBlind);
//     Serial.print("Final accuracy: ");
//     Serial.println(finalAccuracy);

//     // Display result based on higher accuracy
//     displayBasedOnAccuracy(finalAccuracy);
//     delay(5000); // Display for 5 seconds

//     // Print scores for reference
//     Serial.println("=== Comparison Scores ===");
//     Serial.print("Normal Mode Score: ");
//     Serial.println(accuracyNormal);
//     Serial.print("Color-blind Mode Score: ");
//     Serial.println(accuracyColorBlind);
//     Serial.print("Final Selected Score: ");
//     Serial.println(finalAccuracy);
//     Serial.println("==========================");
